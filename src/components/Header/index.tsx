  ...
  return (
    <header className="container z-20 mx-auto w-full px-10 py-6">
      <div className="flex w-full flex-col items-center justify-between space-y-3 lg:flex-row lg:space-y-0">
        <NavLink
          className="flex items-center text-2xl font-bold text-orange-500 no-underline hover:no-underline lg:text-4xl"
          to="https://easilyhanzi.xyz/"
        >
          <img src={logo} className="mr-3 h-16 w-16" alt="Hanzi Learner Logo" />
          <h1>Hanzi Learner</h1>
        </NavLink>
