...
const chineseExam: DictionaryResource[] = [
  {
    id: 'hsk1',
    name: 'HSK 1',
    description: '汉语水平考试一级词汇 (HSK Level 1)',
    category: '汉语学习',
    tags: ['HSK', '基础'],
