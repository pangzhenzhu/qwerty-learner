          ...
          <div className="relative overflow-hidden rounded-3xl border border-gray-100 bg-white p-2 shadow-2xl">
            <div className="overflow-hidden rounded-2xl bg-white">
              ...
              >
                <img
                  src={hotImg}
                  alt="Hanzi Learner 英语学习软件热门词库界面 - CET 四六级雅思托福词汇在线练习"
                  className="w-full flex-shrink-0"
                />
                <img
                  src={directoryImg}
                  alt="Hanzi Learner 免费英语学习软件词库目录 - 支持程序员技术英语学习"
                  className="w-full flex-shrink-0"
                />
                <img src={indexImg} alt="Hanzi Learner 英语打字练习软件主界面 - 在线英语单词记忆训练" className="w-full flex-shrink-0" />
                <img
                  src={hotImg}
                  alt="Hanzi Learner 英语学习软件热门词库界面 - CET 四六级雅思托福词汇在线练习"
                  className="w-full flex-shrink-0"
            ...
            <div className="lg:grid lg:grid-cols-2 lg:gap-12">
              ...
              <div className="mt-16 flex h-[14rem] items-center justify-center rounded-3xl border border-gray-200 bg-white p-8 shadow-2xl lg:mt-0 lg:h-auto lg:p-12">
                <img
                  ...
                  alt={`Hanzi Learner ${detail[activeIndex].title} 功能展示 - 英语学习软件特色功能截图`}
                />
              </div>
            </div>
