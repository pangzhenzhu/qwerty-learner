                ...
                <ScrollArea.Viewport className="h-full w-full ">
                  ...
                  <div className="flex items-center justify-center pb-10 pt-[20rem] text-gray-500">
                    ...
                    <p className="mr-5 w-10/12 text-xs">
                      The dictionary data for this project comes from multiple open source projects and community contributors who provided
                      it free of charge. We are deeply grateful and respect the intellectual property rights of every contributor. These
                      data are for personal learning and research use only, and are strictly prohibited for any commercial purpose. If you
                      are the copyright owner of the data and believe that our use infringes your rights, please contact us via email at the
                      bottom of the website. Upon receipt of a valid copyright complaint, we will remove the relevant content or seek
                      necessary permissions in the shortest possible time. At the same time, we also encourage all users of these data to
                      respect the rights of copyright owners and to comply with all relevant laws and regulations when using these data.
                      Please note that while we strive to ensure the legality and accuracy of all data, we cannot make any guarantees
                      regarding the accuracy, completeness, legality, or reliability of any data. The risk of using these data is entirely
                      borne by the user.
                    </p>
                  </div>
                </ScrollArea.Viewport>
